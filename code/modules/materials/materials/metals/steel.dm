...
/datum/material/steel/generate_recipes()
	...
	recipes += list(
		new /datum/stack_recipe_list("Airlock Assemblies", list(
			...
			new /datum/stack_recipe("refinery airlock assembly", /obj/structure/door_assembly/door_assembly_outpost_refinery, 4, time = 50, one_per_turf = 1, on_floor = 1, recycle_material = "[name]"), // Outpost 21 edit - Engiemed door
		...
		new /datum/stack_recipe_list("Furniture",list(
			...
			new /datum/stack_recipe_list("Sofas",list(
				...
				new /datum/stack_recipe_list("Miscellaneous",list(
					...
					new /datum/stack_recipe("support pole", /obj/structure/dancepole, 2, one_per_turf = 1, on_floor = 1, time = 20), // Outpost 21 edit - Why are these
					new /datum/stack_recipe("dance pole", /obj/structure/stripper_pole, 2, one_per_turf = 1, on_floor = 1, time = 20), // Outpost 21 edit - Different objects
